...
const bentoNormal =
  "Yakiniku, Yakitori samt Sushi (2 rullar, 1 lax, 1 räka). Ris och sallad ingår";
const bentoGyoza = "Yakiniku, Yakitori samt Gyoza. Ris och sallad ingår";
const bentoMiyabi =
  "Yakiniku, Yakitori, Tempura samt Sushi (1 lax, 1 räka, 1 tonfisk). Ris och sallad ingår";
const bentoDeluxe =
  "Yakiniku, Yakitori, Tempura, Gyoza samt Sushi (1 lax, 1 räka, 1 tonfisk). Ris och sallad ingår";
...
export const sweVarmratter: MenuCategory = {
  ...
  dishes: [
    ...
    },
    {
      ...
      description: [
        "Strimlad Entrécôte, serveras med ris samt med 5 bitar blandad sushi",
      ],
    },
    {
      id: 4,
    ...
    },
    {
      ...
      description: [
        "Stekt ris blandat med broccoli, paprika, haricot verts, edamame, morötter och bambuskott sallad ingår",
      ],
    },
    {
      id: 12,
    ...
    },
    {
      ...
      description: [
        "Koreansk rätt som innehåller ris, olika typer av sallader, kimchi och starksås. Toppas med ett stekt ägg",
      ],
    },
    {
      id: 15,
