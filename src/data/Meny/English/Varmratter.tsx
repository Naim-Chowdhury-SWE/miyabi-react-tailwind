...
const bentoNormal =
  "Yakiniku, Yakitori, and Sushi (2 rolls, 1 salmon, 1 shrimp). Rice and salad included";
const bentoGyoza = "Yakiniku, Yakitori, and Gyoza. Rice and salad included";
const bentoMiyabi =
  "Yakiniku, Yakitori, Tempura, and Sushi (1 salmon, 1 shrimp, 1 tuna). Rice and salad included";
const bentoDeluxe =
  "Yakiniku, Yakitori, Tempura, Gyoza, and Sushi (1 salmon, 1 shrimp, 1 tuna). Rice and salad included";
...
export const engVarmratter: MenuCategory = {
  ...
  dishes: [
    ...
    },
    {
      ...
      description: [
        "Sliced Beef, stirfried, then served with rice and 5 pieces of assorted sushi",
      ],
    },
    {
      id: 4,
    ...
    },
    {
      ...
      images: [Gyoza, Gyoza],
      description: [
        "Mixed minced meat-filled dumplings served with rice and sauce",
      ],
    },
    {
      id: 6,
    ...
    },
    {
      ...
      description: [
        "Fried rice mixed with broccoli, bell pepper, green beans, edamame, carrots, and bamboo shoots. Salad included",
      ],
    },
    {
      id: 12,
      ...
      images: [Laxteriyaki],
      description: [
        "Grilled salmon with stir-fried vegetables, teriyaki sauce, and rice",
      ],
    },
    {
      id: 13,
    ...
    },
    {
      ...
      description: [
        "Korean dish with rice, various salads, kimchi, and spicy sauce. Topped with a fried egg",
      ],
    },
    {
      id: 15,
    ...
    },
    {
      ...
      description: [
        "Noodle soup made with egg noodles, vegetables, and boiled egg",
      ],
    },
  ],
};
