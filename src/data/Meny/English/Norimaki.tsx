  ...
  dishes: [
    {
      ...
      description: [
        "Inside-Out seaweed roll with avocado, cucumber, crab stick, and chili mayo",
        "Inside-Out seaweed roll with avocado, cucumber, crab stick. Topped with seared salmon and chili mayo",
      ],
    },
    {
      id: 2,
      ...
      images: [StandardRoll],
      description: [
        "Inside-Out seaweed roll with salmon, cucumber, crab stick",
      ],
    },
    {
      id: 3,
      ...
      description: [
        "Seaweed roll with cucumber and avocado",
        "Seaweed roll with cucumber, avocado, and mango",
        "Avocado, crispy salad, tofu, and vegan mayonnaise. The roll is fried",
      ],
    },
    {
      id: 4,
      ...
      description: [
        "Seaweed roll with chili-marinated tuna",
        "Seaweed roll with chili-marinated salmon",
      ],
    },
    {
      id: 5,
      ...
      description: [
        "Fried seaweed roll with marinated tuna, crispy salad, avocado with chili mayo and sriracha sauce",
        "Fried seaweed roll with marinated salmon, crispy salad, avocado with chili mayo and sriracha sauce",
      ],
    },
    {
      id: 6,
    ...
    },
    {
      ...
      description: [
        "Seaweed roll with tuna and avocado",
        "Seaweed roll with salmon and avocado",
      ],
    },
    {
      id: 10,
    ...
    },
    {
      ...
      images: [FutomakiRoll],
      description: [
        "Seaweed roll with salmon, omelette, cucumber, and avocado",
      ],
    },
    {
      id: 12,
      ...
      description: [
        "Seaweed roll with fried shrimp and chili mayo",
        "Fried Seaweed roll with fried shrimp, cucumber, and chili mayo",
        "Fried Seaweed roll with fried jumbo shrimp, avocado, crispy salad, and chili mayonnaise",
      ],
    },
    {
      id: 13,
      ...
      description: [
        "Fried Seaweed roll with salmon, cucumber, crab, and chili mayo",
        "Fried Seaweed roll with Marinated salmon, avocado, crispy salad, and chili mayonnaise",
      ],
    },
    {
      id: 14,
    ...
    },
    {
      ...
      description: [
        "Seaweed roll with salmon, avocado, cucumber, and Philadelphia cream cheese",
      ],
    },
    {
      id: 16,
      ...
      description: [
        "Seaweed roll with salmon, avocado, and cucumber, topped with chili mayo",
        "Fried Seaweed roll with salmon, avocado, and cucumber, topped with chili mayo",
      ],
    },
    {
      id: 17,
      ...
      images: [YakinikuRoll],
      description: [
        "Seaweed roll with yakiniku beef, bell pepper, lettuce, and red onion, topped with chili mayo",
      ],
    },
    {
      id: 18,
      ...
      images: [TeriyakiRoll],
      description: [
        "Seaweed roll with seared salmon, avocado, onion, and lettuce",
      ],
    },
    {
      id: 19,
      ...
      images: [DragonRoll],
      description: [
        "Shrimp, crispy salad, avocado, dragon sauce, topped with grilled salmon",
      ],
    },
    {
      id: 20,
      ...
      description: [
        "Seaweed roll with cucumber, salad, kimchi, and mixed greens",
      ],
    },
  ],
};
