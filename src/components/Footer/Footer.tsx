  ...
  return (
    <footer className="text-white font-opensans font-semibold lg:text-lg flex flex-col items-center">
      ...
      <img src={logo.logo3} alt="Miyabi Logo" className="mx-8 lg:scale-50" />
        ...
        <address id="contact" className="flex flex-col-reverse md:justify-between md:flex-row m-8 lg:mx-12 xl:mx-40 lg:px-10 xl:px-24">
      ...
      <section className=" bg-red-800 w-full text-black font-bold flex flex-col items-center">
        ...
        <SmoothScroll targetId="Hem">
          <div>
            <p className="mt-2 p-2 rounded-lg hover:bg-red-900 hover:text-white transition duration-300 cursor-pointer">Till Toppen</p>
            </div>
          </SmoothScroll>
